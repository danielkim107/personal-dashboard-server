...
var User = _sequelize.sequelize.models.user;
...
function createSuperuser(_x7, _x8) {
  return _createSuperuser.apply(this, arguments);
}

function _createSuperuser() {
  _createSuperuser = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, res) {
    var body;
...
function _remove() {
  _remove = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, res) {
    var id;
